      ...
      <div className='"container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div className='ml-10'>
          ...
          <p className='text-gray-500 mb-4'>
            Be te first to hear about new products, exclusive events, and online offers
            </p>
        ...
        <li>
          <Link to="#" className="hover:text-gray-500 transition-colors">Womens's Bottom wear</Link>
        </li>
          </ul>
        </div>
        ...
        <div>
         ...
         <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
          <p className='text-gray-500 text-sm tracking-tighter text-center'> © 2025, ShopSphere. All Rights Reserved</p>
         </div>
