        ...
        <div className='flex flex-col md:flex-row'>
          ...
          <div className='hidden md:flex flex-col space-y-4 mr-6'>
            {selectedProduct.images.map((image, index) => (
              <img 
              className={`w-20 h-20 object-cover border rounded-lg cursor-pointer ${mainImage === image.url ? "border-black" : "border-gray-300"}`}
              key={index}
              src={image.url} 
          ...
          />
            ...
            <h1 className='text-2xl md:text-3-xl font-semibold mb-2 '>
